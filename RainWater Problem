...
// the bruete force approach with Time Complexity O(N) and Space Complexity of O(N)
...
// The optimized approach using Two Pointer Technique, whose Time Complexity is O(N) and Space Complexity is O(1)
